...
> 
> Follow Kashish Pandey for updates
...
```bash
git clone https://github.com/kashishpandey/codsoft-todolist-app.git
...
- GitHub: [@kashishpandey](https://github.com/kashishpandey)
- LinkedIn: [Kashish Pandey](https://linkedin.com/in/kashish-pandey)
...
- 🐛 [Open an issue](https://github.com/kashishpandey/codsoft-todolist-app/issues)
